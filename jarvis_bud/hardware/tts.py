...
class SpeechSynth:
    ...
    def __init__(
        self, piper_model: str = "models/piper/en_US-lessac-medium.onnx", profile: str = "standard"
    ):
    ...
    def speak(self, text: str) -> bool:
        ...
        if self.piper_bin and self.aplay_bin:
            try:
                profile = self._profile_settings.get(
                    self.profile, self._profile_settings["standard"]
                )
